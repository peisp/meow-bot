...
export function TopToolbar({
  ...
  return (
    <div className="h-14 backdrop-blur-xl border-b border-gray-200/60 flex items-center justify-between pr-4 pl-16 pt-2 selection-boundary" style={{"--wails-draggable": "drag"} as any}>
      {/* 左侧：对话标题 */}
