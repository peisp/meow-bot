...
export function TopToolbar({
  ...
  return (
    <div className="h-14 bg-toolbar backdrop-blur-xl border-b border-gray-300 shadow-[0_2px_8px_rgba(0,0,0,0.1)] flex items-center justify-between pr-4 pl-16 pt-2 selection-boundary" style={{"--wails-draggable": "drag"} as any}>
      {/* 左侧：对话标题 */}
