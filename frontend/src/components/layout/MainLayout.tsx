    ...
    return (
        <div className="h-screen w-screen flex overflow-hidden fixed inset-0">
            ...
            <div className={cn(
                ...
                isSidebarCollapsed ? "w-0 opacity-0" : "w-[240px] opacity-100"
            )}>
                <ConversationSidebar
            ...
            <div className={cn(
                ...
                {/* 聊天区域 */}
                <div
                    className="flex-1 flex flex-col min-h-0 bg-chat-area backdrop-blur-sm shadow-xl shadow-gray-900/5 overflow-hidden">
                    {/* 消息列表 */}
                    <ChatMessages
